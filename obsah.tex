...
\begin{itemize}
\item {\bf Soubor s nastavením }\\
Soubor s nastavením obsahuje informace, podle kterých se nastaví aplikaèní jednotky . V souboru {\it settings.xml}  je ulo¾ena instance tøídy {\it TestCaseSettingsData}, která nese informace pro spu¹tìní pro testovací a proxy jednotku. \\
...
Zprostøedkovatel dat je reprezentován tøídou {\it DataProvider}, která byla ji¾ v pøedchozí implementaci. Tato tøída má na starosti serializaci a deserializaci Java objektù do respektive z XML reprezentace. K tomuto druhu manipulace je pou¾ita knihovna Xstream. V pøedchozí implementaci byly metody z této tøídy volány pouze staticky. Pro úèely byla tato tøída pøepracována a metody jsou volány z instance dané tøídy.

\subsection*{Kontrolér}
Centrální souèást aplikace, která zasahuje do vìt¹
\subsection*{Grafické u¾ivatelské rozhraní}
asdfsadf
