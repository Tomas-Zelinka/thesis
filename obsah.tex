...
Dynamické testování vy¾aduje spu¹tìní urèité verze programu. Testování probíhá vkládáním mno¾iny vstupù a hodnocení dosa¾ených výstupù.
...
Také známé jako Unit testing neboli testování jednotek. Zde se testují vìt¹í celky kódu programu. Pøi objektovì orientovaném programování se jedná o testování jednotlivých tøíd, jinak je mo¾no testovat vhodnì vymezené úseky kódu.
\subsubsection*{Integraèní testování}
zxcv
\subsubsection*{Systémové testování}
zxcvxcz
\subsubsection*{Akceptaèní testování}
zxcvzxvc
\subsection*{Dal¹í techniky testování software}
sdfa
