...
\item {\bf Bezstavovost}\\
Tato vlastnost u¾ musí být implementována specificky na dané architektuøe, která je postavena nad HTTP protokolem. Pokud je kontext ukládán na serveru, tak se nejedná o aplikaci zalo¾enou na èistì principech REST.  
\item {\bf Mezi-pamì»}\\
...
Data, která jsou odesílání pomocí HTTP mohou být pøená¹ená v jiné reprezentaci ne¾ je jejich ulo¾ení, èili mohou být pøená¹eny jednotným zpùsobem(JSON, XML apod.).
\item {\bf Sebe popisující zprávy }\\
Tuto vlastnost nemusí HTTP protokol splòovat, je tøeba tuto vlastnost doplnit ve vrstvì, která je nad HTTP protokolem.
\item {\bf Hypermédia jako prostøedek stavu aplikace}\\
asfasf
\item {\bf Kód na vy¾ádání}\\
Kód na vy¾ádání je mo¾ností HTTP protokolu,
\end{itemize}



CRUD operace 
Pou¾ití HTTP protokolu pøi konstrukci webových slu¾eb:
