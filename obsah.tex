...
Hlavními specifikacemi pro SOAP webové slu¾by je soubor specifikací s prefixem WS-. Tento soubor specifikací zahrnuje dal¹í funkcionality, které byly vyvinuty nad SOAP protokolem. Patøí mezi nì napø. transakèní zpracování, bezpeènost, spolehlivost atd.
\\\\ 
...
Zprávy jsou v SOAP protokolu definovány jako XML dokument. Tento formát b
\end{itemize}

\subsubsection*{SOAP dokument styl}

\subsubsection*{SOAP RPC styl}
