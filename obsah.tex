...
\subsubsection*{URI} 
Universal Resource Identifier zkratka pro jednotný identifikátor zdroje. Je textový øetìzec, který má definovanou strukturu. Slou¾í k identifikaci zdroje v poèítaèových sítích, zejména internetu. Pod pojmem zdroj je v tomto kontextu my¹len dokument nebo slu¾ba.
...
\subsubsection*{REST}
Zkratka REST znamená REpresentation State Transfer. Oznaèuje architekturu pro multimediální distribuované systémy. V tìchto systémech jsou ulo¾eny dokumenty nebo slu¾by, které jsou identifikovány pomocí URI. Architektura REST není pøímo svázaná s konkrétním komunikaèním protokolem. Jeliko¾ HTTP protokol nejlépe vyhovuje designu REST architektury, je s touto architekturou ve vìt¹inì pøípadù spojován.
